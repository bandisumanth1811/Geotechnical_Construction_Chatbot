...
# Grounded system prompt: LLM must only answer from retrieved context
_SYSTEM_PROMPT = """You are an expert geotechnical and construction engineering assistant for SUNY Polytechnic Institute.
You answer questions ONLY based on the technical documents provided to you as context.
Rules you must follow:
1. Base every answer strictly on the retrieved context passages. Do not use outside knowledge.
...
3. Be precise, technical, and use correct geotechnical terminology.
...
def make_chain(vectorstore, api_key: str):
    ...
    # Build a chat prompt that injects the grounded system message
    messages = [
...
with tab_references:
    ...
    - [Types of Retaining Walls - Tensar International](https://www.tensarinternational.com/resources/articles/types-of-retaining-wall)
    - [Different Types of Retaining Walls - 757Brick](https://757brick.com/blog/different-types-of-retaining-walls/)
    - [All About Retaining Walls - This Old House](https://www.thisoldhouse.com/masonry/all-about-retaining-walls)
    - [4 Types of Retaining Walls - GC Landscape](https://gclandscape.com/4-types-of-retaining-walls-which-one-you-need-for-your-landscape-project/)
    """)
    
    st.divider()
    
    # Retaining Wall Design & Concepts
    st.markdown("### Retaining Wall Design & Concepts")
    st.markdown("""
    - [Retaining Wall Design Guide - Tensar](https://www.tensarinternational.com/resources/articles/types-of-retaining-wall)
    - [Lateral Earth Pressure & Design Considerations - Tensar](https://www.tensarinternational.com/resources/articles/types-of-retaining-wall)
    - [Retaining Wall Problems & Solutions - This Old House](https://www.thisoldhouse.com/masonry/all-about-retaining-walls)
    """)
    
    st.divider()
    
    # Sheet Piles & Sheet Pile Walls
    st.markdown("### Sheet Piles & Sheet Pile Walls")
    st.markdown("""
    - [Sheet Piles Overview - Keller](https://www.keller-na.com/expertise/techniques/sheet-piles)
    - [Steel Sheet Piling Products - Nucor Skyline](https://www.nucorskyline.com/globalnav/products/steel-sheet-piling)
    - [Intro to Steel Sheet Piling - Nucor](https://nucor.com/newsroom/intro-to-steel-sheet-piling-applications-and-benefits-in-construction)
    - [Sheet Pile Wall Types - Deep Excavation](https://www.deepexcavation.com/post/sheet-pile-wall-types)
    """)
    
    st.divider()
    
    # Retaining Wall Materials & Applications
    st.markdown("### Retaining Wall Materials & Applications")
    st.markdown("""
    - [Retaining Wall Materials & Design - This Old House](https://www.thisoldhouse.com/masonry/all-about-retaining-walls)
    - [Retaining Wall Applications & Uses - Nucor](https://nucor.com/newsroom/intro-to-steel-sheet-piling-applications-and-benefits-in-construction)
    """)
